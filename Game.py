...
Blank_img = PhotoImage(file="C:/Users/manji/Desktop/Internship/CodSoftPython/Task4Game/resources/blank.png")
Player_Rock = PhotoImage(file="C:/Users/manji/Desktop/Internship/CodSoftPython/Task4Game/resources/rock_player.png")
Player_Rock_ado = Player_Rock.subsample(3, 3)
Player_Paper = PhotoImage(file="C:/Users/manji/Desktop/Internship/CodSoftPython/Task4Game/resources/paper_player.png")
Player_Paper_ado = Player_Paper.subsample(3, 3)
Player_Scissor = PhotoImage(file="C:/Users/manji/Desktop/Internship/CodSoftPython/Task4Game/resources/scissor_player.png")
Player_Scissor_ado = Player_Scissor.subsample(3, 3)
Computer_Rock = PhotoImage(file="C:/Users/manji/Desktop/Internship/CodSoftPython/Task4Game/resources/rock_computer.png")
Computer_Paper = PhotoImage(file="C:/Users/manji/Desktop/Internship/CodSoftPython/Task4Game/resources/paper_computer.png")
Computer_Scissor = PhotoImage(file="C:/Users/manji/Desktop/Internship/CodSoftPython/Task4Game/resources/scissor_computer.png")

def PlayAgain():
    result = messagebox.askyesno("Play Again", "Do you want to play again?")
    if result:
        # Reset the game
...
play_again = Button(root, text="Play Again", bg="green", fg="white", font=('Times New Roman', 25, 'bold'), command=PlayAgain)
play_again.grid(row=5, column=1)
